"""
Installer script to set up wyoming-macos-stt as a background service.
...
_LAUNCHER_NAME = "WyomingSTT"
_LABEL = "com.openhoster.wyoming-macos-stt"
_REQUIREMENTS = ["uv", "yap"]
...
_LAUNCHER_SCRIPT = """
#!/bin/bash
exec uv run -m wyoming_macos_stt \\
    --uri tcp://0.0.0.0:10300 \\
    --service-name macos-stt \\
    --yap-args "-m 500" \\
    --log-dir ./logs \\
    --log-keep-days 7 "$@"
"""
...
async def verify(max_retries=5, delay=1):
    ...
    client = AsyncTcpClient("localhost", 10300)
